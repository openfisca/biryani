...
...
>>> french_translation = gettext.translation('biryani1', languages = ['fr'])
...
...
...                 'biryani1', fallback = True, languages = languages)
...
For example, if the application using *Biryani* is named **myapp** and stores its localized messages in ``myapp/i18n`` you could chain its translations with those of *Biryani* using some code like::
    ...
    languages = ['fr']
    biryani_translation = gettext.translation('biryani1', fallback = True, languages = languages)
