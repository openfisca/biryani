...
>>> conv.pipe(conv.str_to_int, conv.not_none)(None, state = french_state)
(None, u'Valeur manquante')
>>> conv.pipe(conv.str_to_int, conv.not_none)(u'Hello world!')
(u'Hello world!', u'Value must be an integer')
>>> conv.pipe(conv.str_to_int, conv.not_none)(u'Hello world!', state = french_state)
...
(None, u'Valeur manquante')
>>> conv.pipe(conv.str_to_int, conv.not_none)(u'Hello world!', state = french_user_state)
(u'Hello world!', u'La valeur doit \xeatre un entier')
